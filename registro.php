    ...
    <div class="row justify-content-center">
        <div class="col-md-6 col-md-offset-3" align="center">
            ...
            <form method="post" action="registro.php">
                <input class="form-control" minlength="3" name="nombre" placeholder="Nombre..."><br>
                ...
                <input class="btn btn-primary" name="submit" type="submit" value="Registrarse..."><br>
